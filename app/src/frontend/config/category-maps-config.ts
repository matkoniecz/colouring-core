...
export const categoryMapsConfig: {[key in Category]: CategoryMapDefinition[]} = {
    ...
    [Category.LandUse]: [
        ...
        },
        {
            ...
            legend: {
                title: 'Land cover',
                description: 'CORINE land cover classification',
                elements: [
                    { color: "#e6004d", text: '111 - Continuous urban fabric' },
                    { color: "#ff0000", text: '112 - Discontinuous urban fabric' },
                    { color: "#cc4df2", text: '121 - Industrial or commercial units' },
                    { color: "#cc0000", text: '122 - Road and rail networks and associated land' },
                    { color: "#e6cccc", text: '123 - Port areas' },
                    { color: "#e6cce6", text: '124 - Airports' },
                    { color: "#a600cc", text: '131 - Mineral extraction sites' },
                    { color: "#a64d00", text: '132 - Dump sites' },
                    { color: "#ff4dff", text: '133 - Construction sites' },
                    { color: "#ffa6ff", text: '141 - Green urban areas' },
                    { color: "#ffe6ff", text: '142 - Sport and leisure facilities' },
                    { color: "#ffffa8", text: '211 - Non-irrigated arable land' },
                    { color: "#f2a64d", text: '222 - Fruit trees and berry plantations' },
                    { color: "#e6e64d", text: '231 - Pastures' },
                    { color: "#ffe64d", text: '242 - Complex cultivation patterns' },
                    { color: "#e6cc4d", text: '243 - Land principally occupied by agriculture with significant areas of natural vegetation' },
                    { color: "#f2cca6", text: '244 - Agro-forestry areas' },
                    { color: "#80ff00", text: '311 - Broad-leaved forest' },

                    { color: "#ffff00", text: '212 - Permanently irrigated land' },
                    { color: "#e6e600", text: '213 - Rice fields' },
                    { color: "#e68000", text: '221 - Vineyards' },
                    { color: "#e6a600", text: '223 - Olive groves' },
                    { color: "#ffe6a6", text: '241 - Annual crops associated with permanent crops' },
                    { color: "#00a600", text: '312 - Coniferous forest' },
                    { color: "#4dff00", text: '313 - Mixed forest' },
                    { color: "#ccf24d", text: '321 - Natural grasslands' },
                    { color: "#a6ff80", text: '322 - Moors and heathland' },
                    { color: "#a6e64d", text: '323 - Sclerophyllous vegetation' },
                    { color: "#a6f200", text: '324 - Transitional woodland-shrub' },
                    { color: "#e6e6e6", text: '331 - Beaches - dunes - sands' },
                    { color: "#cccccc", text: '332 - Bare rocks' },
                    { color: "#ccffcc", text: '333 - Sparsely vegetated areas' },
                    { color: "#000000", text: '334 - Burnt areas' },
                    { color: "#a6e6cc", text: '335 - Glaciers and perpetual snow' },
                    { color: "#a6a6ff", text: '411 - Inland marshes' },
                    { color: "#4d4dff", text: '412 - Peat bogs' },
                    { color: "#ccccff", text: '421 - Salt marshes' },
                    { color: "#e6e6ff", text: '422 - Salines' },
                    { color: "#a6a6e6", text: '423 - Intertidal flats' },
                    { color: "#00ccf2", text: '511 - Water courses' },
                    { color: "#80f2e6", text: '512 - Water bodies' },
                    { color: "#00ffa6", text: '521 - Coastal lagoons' },
                    { color: "#a6ffe6", text: '522 - Estuaries' },
                    { color: "#e6f2ff", text: '523 - Sea and ocean' },
                ]
            },
        },
    ],
