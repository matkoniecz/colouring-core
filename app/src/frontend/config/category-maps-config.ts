    ...
    [Category.LandUse]: [
        ...
        },
        {
            ...
            legend: {
                ...
                elements: [
                    { color: "#e6004d", text: 'Continuous urban fabric' },
                    { color: "#ff0000", text: 'Discontinuous urban fabric' },
                    { color: "#cc4df2", text: 'Industrial or commercial units' },
                    { color: "#cc0000", text: 'Road and rail networks and associated land' },
                    { color: "#e6cccc", text: 'Port areas' },
                    { color: "#e6cce6", text: 'Airports' },
                    { color: "#a600cc", text: 'Mineral extraction sites' },
                    { color: "#a64d00", text: 'Dump sites' },
                    { color: "#ff4dff", text: 'Construction sites' },
                    { color: "#ffa6ff", text: 'Green urban areas' },
                    { color: "#ffe6ff", text: 'Sport and leisure facilities' },
                    { color: "#ffffa8", text: 'Non-irrigated arable land' },
                    { color: "#ffff00", text: 'Permanently irrigated land' },
                    { color: "#e6e600", text: 'Rice fields' },
                    { color: "#e68000", text: 'Vineyards' },
                    { color: "#f2a64d", text: 'Fruit trees and berry plantations' },
                    { color: "#e6a600", text: 'Olive groves' },
                    { color: "#e6e64d", text: 'Pastures' },
                    { color: "#ffe6a6", text: 'Annual crops associated with permanent crops' },
                    { color: "#ffe64d", text: 'Complex cultivation patterns' },
                    { color: "#e6cc4d", text: 'Land principally occupied by agriculture with significant areas of natural vegetation' },
                    { color: "#f2cca6", text: 'Agro-forestry areas' },
                    { color: "#80ff00", text: 'Broad-leaved forest' },
                    { color: "#00a600", text: 'Coniferous forest' },
                    { color: "#4dff00", text: 'Mixed forest' },
                    { color: "#ccf24d", text: 'Natural grasslands' },
                    { color: "#a6ff80", text: 'Moors and heathland' },
                    { color: "#a6e64d", text: 'Sclerophyllous vegetation' },
                    { color: "#a6f200", text: 'Transitional woodland-shrub' },
                    { color: "#e6e6e6", text: 'Beaches - dunes - sands' },
                    { color: "#cccccc", text: 'Bare rocks' },
                    { color: "#ccffcc", text: 'Sparsely vegetated areas' },
                    { color: "#000000", text: 'Burnt areas' },
                    { color: "#a6e6cc", text: 'Glaciers and perpetual snow' },
                    { color: "#a6a6ff", text: 'Inland marshes' },
                    { color: "#4d4dff", text: 'Peat bogs' },
                    { color: "#ccccff", text: 'Salt marshes' },
                    { color: "#e6e6ff", text: 'Salines' },
                    { color: "#a6a6e6", text: 'Intertidal flats' },
                    { color: "#00ccf2", text: 'Water courses' },
                    { color: "#80f2e6", text: 'Water bodies' },
                    { color: "#00ffa6", text: 'Coastal lagoons' },
                    { color: "#a6ffe6", text: 'Estuaries' },
                    { color: "#e6f2ff", text: 'Sea and ocean' },
                ]
            },
        },
    ],
