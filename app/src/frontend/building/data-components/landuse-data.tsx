const landuseCodesData = {"AA/RAC Service Centres and Boxes": {
    ...
    NACE_level_3: {code: "95.3", description: "Repair and maintenance of motor vehicles and motorcycles"},
...
"Advertising Right": {
    ...
    NACE_level_3: {code: "73.1", description: "Advertising"},
...
"Agricultural Showgrounds (National Scheme)": {
    ...
    NACE_level_3: {code: "47.1", description: "Non-specialised retail sale"},
...
"Aircraft Works With Airfields": {
    ...
    NACE_level_3: {code: "30.3", description: "Manufacture of air and spacecraft and related machinery"},
...
"Aluminum Smelting Works": {
    ...
    NACE_level_3: {code: "24.4", description: "Manufacture of basic precious and other non-ferrous metals"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Ambulance Stations": {
    ...
    NACE_level_3: {code: "84.2", description: "Provision of services to the community as a whole"},
...
"Amusement Arcades": {
    ...
    NACE_level_3: {code: "93.2", description: "Amusement and recreation activities"},
...
"Artificial Fibre Works": {
    ...
    NACE_level_3: {code: "20.6", description: "Manufacture of man-made fibres"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Asphalt Plants": {
    ...
    NACE_level_3: {code: "23.6", description: "Manufacture of articles of concrete, cement and plaster"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"ATMs": {
    ...
    NACE_level_3: {code: "64.1", description: "Monetary intermediation"},
...
"Auction Rooms": {
    ...
    NACE_level_3: {code: "47.7", description: "Retail sale of other goods, except motor vehicles and motorcycles"},
    NACE_level_1: {code: "G", description: "Wholesale and retail trade"},
...
"Baling Plants": {
    ...
    NACE_level_3: {code: "01.3", description: "Plant propagation"},
...
"Beet Sugar Factories": {
    ...
    NACE_level_3: {code: "10.8", description: "Manufacture of other food products"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Bird Sanctuaries": {
    ...
    NACE_level_3: {code: "91.4", description: "Botanical and zoological garden and nature reserve activities"},
    NACE_level_1: {code: "S", description: "Arts, sports and recreation"},
...
"Boat Yards": {
    ...
    NACE_level_3: {code: "30.1", description: "Building of ships and boats"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Breweries (National Scheme)": {
    ...
    NACE_level_3: {code: "11.0", description: "Manufacture of beverages"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Brickworks (Traditional), Clay Tile/Pipe Works": {
    ...
    NACE_level_3: {code: "23.3", description: "Manufacture of clay building materials"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Bulk Cement Storage Depots": {
    ...
    NACE_level_3: {code: "52.1", description: "Warehousing and storage"},
    NACE_level_1: {code: "H", description: "Transportation and storage"},
...
"Cable Head End Buildings": {
    ...
    NACE_level_3: {code: "61.1", description: "Wired, wireless, and satellite telecommunication activities"},
...
"Cemeteries (National Scheme)": {
    ...
    NACE_level_3: {code: "96.3", description: "Funeral and related activities"},
    NACE_level_1: {code: "T", description: "Other services activities"},
...
"Cinemas (National Scheme)": {
    ...
    NACE_level_3: {code: "59.1", description: "Motion picture, video and television programme activities"},
...
"Civic and Public Buildings (Local Authority Occupations)": {
    ...
    NACE_level_3: {code: "84.1", description: "Administration of the State and the economic, social and environmental policies of the community"},
    NACE_level_1: {code: "P", description: "Public administration and defence; compulsory social security"},
...
"Inns": {
    ...
    NACE_level_3: {code: "55.1", description: "Hotels and similar accommodation"},
    NACE_level_1: {code: "I", description: "Accommodation and food service activities"},
...
"Coking and Carbonising Plants": {
    ...
    NACE_level_3: {code: "19.1", description: "Manufacture of coke oven products"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Colleges of Further Education (National Scheme)": {
    ...
    NACE_level_3: {code: "85.3", description: "Secondary and post-secondary non-tertiary education"},
...
"Computer Centres (Non-Purpose Built)": {
    ...
    NACE_level_3: {code: "63.1", description: "Computing infrastructure, data processing, hosting and related activities"},
    NACE_level_1: {code: "K", description: "Telecommunication, computer programming, consulting, computing infrastructure and other information service activities"},
...
"Concert Halls (National Scheme)": {
    ...
    NACE_level_3: {code: "90.3", description: "Support activities to arts creation and performing arts"},
    NACE_level_1: {code: "S", description: "Arts, sports and recreation"},
...
"Conference & Exhibition Centres": {
    ...
    NACE_level_3: {code: "82.3", description: "Organisation of conventions and trade shows"},
...
"Wedding & Function Venues": {
    ...
    NACE_level_3: {code: "96.9", description: "Other personal service activities"},
    NACE_level_1: {code: "T", description: "Other services activities"},
...
"Contractors Huts & Compounds": {
    ...
    NACE_level_3: {code: "43.1", description: "Demolition and site preparation"},
...
"Creameries": {
    ...
    NACE_level_3: {code: "10.5", description: "Manufacture of dairy products and edible ice"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Day Nurseries/Play Schools": {
    ...
    NACE_level_3: {code: "85.1", description: "Pre-primary education"},
    NACE_level_1: {code: "Q", description: "Education"},
...
"District Heating Undertakings & Networks": {
    ...
    NACE_level_3: {code: "35.3", description: "Steam and air conditioning supply"},
...
"Domestic Fuel Installations": {
    ...
    NACE_level_3: {code: "35.2", description: "Manufacture of gas, and distribution of gaseous fuels through mains"},
    NACE_level_1: {code: "D", description: "Electricity, gas, steam and air conditioning supply"},
...
"Drive-In Restaurants": {
    ...
    NACE_level_3: {code: "56.1", description: "Restaurants and mobile food service activities"},
    NACE_level_1: {code: "I", description: "Accommodation and food service activities"},
...
"Mine Water Treatment Plant and Premises": {
    ...
    NACE_level_3: {code: "36.0", description: "Water collection, treatment and supply"},
...
"Electricity Undertakings (Non- Statutory)": {
    ...
    NACE_level_3: {code: "35.1", description: "Electric power generation, transmission and distribution"},
    NACE_level_1: {code: "D", description: "Electricity, gas, steam and air conditioning supply"},
...
"Factories, Workshops and Warehouses (Incl Bakeries & Dairies)": {
    ...
    NACE_level_3: {code: "10.7", description: "Manufacture of bakery and farinaceous products"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Fish Farms": {
    ...
    NACE_level_3: {code: "03.2", description: "Aquaculture"},
    NACE_level_1: {code: "A", description: "Agriculture, forestry and fishing"},
...
"Flour Mills (National Scheme)": {
    ...
    NACE_level_3: {code: "10.6", description: "Manufacture of grain mill products, starches and starch products"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Health Farms": {
    ...
    NACE_level_3: {code: "86.9", description: "Other human health activities"},
    NACE_level_1: {code: "R", description: "Human health and social work activities"},
...
"Heredits Used For Primary Treatment/Processing Of Minerals": {
    ...
    NACE_level_3: {code: "08.1", description: "Quarrying of stone, sand and clay"},
...
"Heritage Railways": {
    ...
    NACE_level_3: {code: "49.1", description: "Passenger rail transport"},
    NACE_level_1: {code: "H", description: "Transportation and storage"},
...
"Hospitals & Clinics NHS (National Scheme)": {
    ...
    NACE_level_3: {code: "86.1", description: "Hospital activities"},
    NACE_level_1: {code: "R", description: "Human health and social work activities"},
...
"Interactive Telephone Kiosks": {
    ...
    NACE_level_3: {code: "61.9", description: "Other telecommunication activities"},
    NACE_level_1: {code: "K", description: "Telecommunication, computer programming, consulting, computing infrastructure and other information service activities"},
...
"Iron and/or Steel Works": {
    ...
    NACE_level_3: {code: "24.1", description: "Manufacture of basic iron and steel and of ferro-alloys"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Land used for Waste Composting": {
    ...
    NACE_level_3: {code: "38.2", description: "Waste recovery"},
    NACE_level_1: {code: "E", description: "Water supply; sewerage; waste managment and remediation activities"},
...
"Libraries": {
    ...
    NACE_level_3: {code: "91.1", description: "Library and archive activities"},
    NACE_level_1: {code: "S", description: "Arts, sports and recreation"},
...
"Mineral Producing Hereditament - Coal": {
    ...
    NACE_level_3: {code: "05.1", description: "Mining of hard coal"},
    NACE_level_1: {code: "B", description: "Mining and quarrying"},
...
"Mineral Producing Hereditament - Oil": {
    ...
    NACE_level_3: {code: "06.1", description: "Extraction of crude petroleum"},
    NACE_level_1: {code: "B", description: "Mining and quarrying"},
...
"Mineral Producing Hereditament With Coating Plant": {
    ...
    NACE_level_3: {code: "20.3", description: "Manufacture of paints, varnishes and similar coatings, printing ink and mastics"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Motor Vehicle Works": {
    ...
    NACE_level_3: {code: "29.1", description: "Manufacture of motor vehicles"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Newspaper Printing Works (National Scheme)": {
    ...
    NACE_level_3: {code: "18.1", description: "Printing and service activities related to printing"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Offices (Headquarters/Institutional)": {
    ...
    NACE_level_3: {code: "70.1", description: "Activities of head offices"},
    NACE_level_1: {code: "N", description: "Professional, scientific and technical activities"},
...
"Oxbridge Colleges": {
    ...
    NACE_level_3: {code: "85.4", description: "Tertiary education"},
    NACE_level_1: {code: "Q", description: "Education"},
...
"Paper Mills": {
    ...
    NACE_level_3: {code: "17.1", description: "Manufacture of pulp, paper and paperboard"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Petrol Filling Stations (National Scheme)": {
    ...
    NACE_level_3: {code: "47.3", description: "Retail sale of automotive fuel"},
    NACE_level_1: {code: "G", description: "Wholesale and retail trade"},
...
"Photographic Booths": {
    ...
    NACE_level_3: {code: "74.2", description: "Photographic activities"},
    NACE_level_1: {code: "N", description: "Professional, scientific and technical activities"},
...
"Pipelines": {
    ...
    NACE_level_3: {code: "49.5", description: "Transport via pipeline"},
    NACE_level_1: {code: "H", description: "Transportation and storage"},
...
"Public Houses/Pub Restaurants (National Scheme)": {
    ...
    NACE_level_3: {code: "56.3", description: "Beverage serving activities"},
    NACE_level_1: {code: "I", description: "Accommodation and food service activities"},
...
"Sales Kiosks": {
    ...
    NACE_level_3: {code: "47.9", description: "Intermediation service activities for retail sale"},
    NACE_level_1: {code: "G", description: "Wholesale and retail trade"},
...
"Scrap Metal/Breakers Yard": {
    ...
    NACE_level_3: {code: "32.9", description: "Manufacturing not elsewhere classified"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Sea Dredged Aggregate Processing Plants & Depots": {
    ...
    NACE_level_3: {code: "42.9", description: "Construction of other civil engineering projects"},
    NACE_level_1: {code: "F", description: "Construction"},
...
"Tanneries": {
    ...
    NACE_level_3: {code: "15.1", description: "Tanning, dyeing, dressing of leather and fur; manufacture of luggage, handbags, saddlery and harness"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Vehicle Testing Centres (With Test Tracks)": {
    ...
    NACE_level_3: {code: "71.2", description: "Technical testing and analysis"},
    NACE_level_1: {code: "N", description: "Professional, scientific and technical activities"},
...
"Village Halls, Scout Huts, Cadet Huts Etc": {
    ...
    NACE_level_3: {code: "94.9", description: "Activities of other membership organisations"},
    NACE_level_1: {code: "T", description: "Other services activities"},
...
"Vineyards/Wineries": {
    ...
    NACE_level_3: {code: "01.2", description: "Growing of perennial crops"},
    NACE_level_1: {code: "A", description: "Agriculture, forestry and fishing"},
...
"Wafer Fabrications (National Scheme)": {
    ...
    NACE_level_3: {code: "26.1", description: "Manufacture of electronic components and boards"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Business Units": {
    ...
    NACE_level_3: {code: "82.1", description: "Office administrative and support activities"},
    NACE_level_1: {code: "O", description: "Administrative and support service activities"},
...
"Hairdressing/Beauty Salons": {
    ...
    NACE_level_3: {code: "96.2", description: "Hairdressing, beauty treatment, day spa and similar activities"},
    NACE_level_1: {code: "T", description: "Other services activities"},
    UK_SIC: {code: "96.09", description: "Other personal service activities n.e.c."},
...
"Pack Houses": {
    ...
    NACE_level_3: {code: "82.9", description: "Business support service activities not elsewhere classified"},
    NACE_level_1: {code: "O", description: "Administrative and support service activities"},
...
"Post Offices": {
    ...
    NACE_level_3: {code: "53.1", description: "Postal activities under universal service obligation"},
    NACE_level_1: {code: "H", description: "Transportation and storage"},
...
"Pumping Mines": {
    ...
    NACE_level_3: {code: "09.9", description: "Support activities for other mining and quarrying"},
    NACE_level_1: {code: "B", description: "Mining and quarrying"},
...
"Workshops Within/Part of Specialist Property": {
    ...
    NACE_level_3: {code: "25.6", description: "Manufacture of cutlery, tools and general hardware"},
    NACE_level_1: {code: "C", description: "Manufacturing"},
...
"Driving Standards Agency Centre": {
    ...
    NACE_level_3: {code: "74.9", description: "Other professional, scientific and technical activities not elsewhere classified"},
    NACE_level_1: {code: "N", description: "Professional, scientific and technical activities"},
...
"Rail Freight Depots": {
    ...
    NACE_level_3: {code: "49.2", description: "Freight rail transport"},
    NACE_level_1: {code: "H", description: "Transportation and storage"},
...
"Builders Merchant": {
    ...
    NACE_level_3: {code: "77.3", description: "Rental and leasing of other machinery, equipment and tangible goods"},
    NACE_level_1: {code: "O", description: "Administrative and support service activities"},
...
"Secure Childrens Homes": {
    ...
    NACE_level_3: {code: "87.9", description: "Other residential care activities"},
    NACE_level_1: {code: "R", description: "Human health and social work activities"},
...
export default landuseCodesData;
