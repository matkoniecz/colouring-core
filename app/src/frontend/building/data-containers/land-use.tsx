...
"Growing of non-perennial crops": {
    ...
    ISIC: {code: "01.1", description: "Growing of non-perennial crops"},
...
"Growing of perennial crops": {
    ...
    ISIC: {code: "01.2", description: "Growing of perennial crops"},
...
"Plant propagation": {
    ...
    ISIC: {code: "01.3", description: "Plant propagation"},
...
"Animal production": {
    ...
    ISIC: {code: "01.4", description: "Animal production"},
    NACE: {code: "01.4", description: "Animal production"},
    UK_SIC: {code: "01.4", description: "Animal production"},
},
"Mixed farming": {
    CPA: {code: "01.5", description: ""},
    ISIC: {code: "01.5", description: "Mixed farming"},
...
"Support activities to agriculture and post-harvest crop activities": {
    ...
    ISIC: {code: "01.6", description: "Support activities to agriculture and post-harvest crop activities"},
...
"Hunting, trapping and related service activities": {
    ...
    ISIC: {code: "01.7", description: "Hunting, trapping and related service activities"},
...
"Silviculture and other forestry activities": {
    ...
    ISIC: {code: "02.1", description: "Silviculture and other forestry activities"},
...
"Logging": {
    ...
    ISIC: {code: "02.2", description: "Logging"},
...
"Gathering of wild growing non-wood products": {
    ...
    ISIC: {code: "02.3", description: "Gathering of non-wood forest products"},
...
"Support activities for fishing and aquaculture": {
    CPA: {code: "03.3", description: ""},
    ISIC: {code: "03.3", description: "Support activities for fishing and aquaculture"},
    NACE: {code: "03.3", description: "Support activities for fishing and aquaculture"},
    UK_SIC: {code: "03.3", description: ""},
},
"Mining of hard coal": {
    CPA: {code: "05.1", description: "Hard coal and other coal"},
    ISIC: {code: "05.1", description: "Mining of hard coal"},
...
"Mining of lignite": {
    ...
    ISIC: {code: "05.2", description: "Mining of lignite"},
...
"Extraction of crude petroleum": {
    ...
    ISIC: {code: "06.1", description: "Extraction of crude petroleum"},
...
"Extraction of natural gas": {
    ...
    ISIC: {code: "06.2", description: "Extraction of natural gas"},
...
"Mining of iron ores": {
    ...
    ISIC: {code: "07.1", description: "Mining of iron ores"},
...
"Mining of non-ferrous metal ores": {
    ...
    ISIC: {code: "07.2", description: "Mining of non-ferrous metal ores"},
...
"Quarrying of stone, sand and clay": {
    ...
    ISIC: {code: "08.1", description: "Quarrying of stone, sand and clay"},
...
"Mining and quarrying n.e.c.": {
    ...
    ISIC: {code: "08.9", description: "Mining and quarrying n.e.c."},
...
"Support activities for petroleum and natural gas extraction": {
    ...
    ISIC: {code: "09.1", description: "Support activities for petroleum and natural gas extraction"},
...
"Support activities for other mining and quarrying": {
    ...
    ISIC: {code: "09.9", description: "Support activities for other mining and quarrying"},
...
"Processing and preserving of meat and production of meat products": {
    ...
    ISIC: {code: "10.1", description: "Processing and preserving of meat"},
...
"Processing and preserving of fish, crustaceans and molluscs": {
    ...
    ISIC: {code: "10.2", description: "Processing and preserving of fish, crustaceans and molluscs"},
...
"Processing and preserving of fruit and vegetables": {
    ...
    ISIC: {code: "10.3", description: "Processing and preserving of fruit and vegetables"},
...
"Manufacture of vegetable and animal oils and fats": {
    ...
    ISIC: {code: "10.4", description: "Manufacture of vegetable and animal oils and fats"},
...
"Manufacture of dairy products and edible ice": {
    ...
    ISIC: {code: "10.5", description: "Manufacture of dairy products"},
...
"Manufacture of grain mill products, starches and starch products": {
    ...
    ISIC: {code: "10.6", description: "Manufacture of grain mill products, starches and starch products"},
...
"Manufacture of bakery and farinaceous products": {
    ...
    ISIC: {code: "10.7", description: "Manufacture of other food products"},
...
"Manufacture of other food products": {
    ...
    ISIC: {code: "10.8", description: "Manufacture of prepared animal feeds"},
...
"Manufacture of beverages": {
    ...
    ISIC: {code: "11.0", description: "Manufacture of beverages"},
...
"Manufacture of tobacco products": {
    ...
    ISIC: {code: "12.0", description: "Manufacture of tobacco products"},
...
"Preparation and spinning of textile fibres": {
    ...
    ISIC: {code: "13.1", description: "Spinning, weaving and finishing of textiles"},
...
"Manufacture of other textiles": {
    ...
    ISIC: {code: "13.9", description: "Manufacture of other textiles"},
...
"Manufacture of knitted and crocheted apparel": {
    ...
    ISIC: {code: "14.1", description: "Manufacture of wearing apparel, except fur apparel"},
...
"Manufacture of other wearing apparel and accessories": {
    ...
    ISIC: {code: "14.2", description: "Manufacture of articles of fur"},
...
"Tanning, dyeing, dressing of leather and fur; manufacture of luggage, handbags, saddlery and harness": {
    ...
    ISIC: {code: "15.1", description: "Tanning, dyeing, dressing of leather and fur; manufacture of luggage, handbags, saddlery and harness"},
...
"Manufacture of footwear": {
    ...
    ISIC: {code: "15.2", description: "Manufacture of footwear"},
...
"Sawmilling and planing of wood; processing and finishing of wood": {
    ...
    ISIC: {code: "16.1", description: "Sawmilling and planing of wood"},
...
"Manufacture of products of wood, cork, straw and plaiting materials": {
    ...
    ISIC: {code: "16.2", description: "Manufacture of products of wood, cork, straw and plaiting materials"},
...
"Printing and service activities related to printing": {
    ...
    ISIC: {code: "18.1", description: "Printing and service activities related to printing"},
...
"Reproduction of recorded media": {
    ...
    ISIC: {code: "18.2", description: "Reproduction of recorded media"},
...
"Manufacture of coke oven products": {
    ...
    ISIC: {code: "19.1", description: "Manufacture of coke oven products"},
...
"Manufacture of refined petroleum products and fossil fuel products": {
    ...
    ISIC: {code: "19.2", description: "Manufacture of refined petroleum products; manufacture of fossil fuel products"},
...
"Manufacture of basic chemicals, fertilisers and nitrogen compounds, plastics and synthetic rubber in primary forms": {
    ...
    ISIC: {code: "20.1", description: "Manufacture of basic chemicals, fertilizers and nitrogen compounds, plastics and synthetic rubber in primary forms"},
...
"Manufacture of pesticides, disinfectants and other agrochemical products": {
    ...
    ISIC: {code: "20.2", description: "Manufacture of other chemical products"},
...
"Manufacture of paints, varnishes and similar coatings, printing ink and mastics": {
    ...
    ISIC: {code: "20.3", description: "Manufacture of man-made fibres"},
...
"Manufacture of rubber products": {
    ...
    ISIC: {code: "22.1", description: "Manufacture of rubber products"},
...
"Manufacture of plastic products": {
    ...
    ISIC: {code: "22.2", description: "Manufacture of plastics products"},
...
"Manufacture of glass and glass products": {
    ...
    ISIC: {code: "23.1", description: "Manufacture of glass and glass products"},
...
"Manufacture of abrasive products and non-metallic mineral products n.e.c.": {
    ...
    ISIC: {code: "23.9", description: "Manufacture of non-metallic mineral products n.e.c."},
...
"Manufacture of basic iron and steel and of ferro-alloys": {
    ...
    ISIC: {code: "24.1", description: "Manufacture of basic iron and steel"},
...
"Manufacture of tubes, pipes, hollow profiles and related fittings, of steel": {
    ...
    ISIC: {code: "24.2", description: "Manufacture of basic precious and other non-ferrous metals"},
...
"Manufacture of other products of first processing of steel": {
    ...
    ISIC: {code: "24.3", description: "Casting of metals"},
...
"Manufacture of structural metal products": {
    ...
    ISIC: {code: "25.1", description: "Manufacture of structural metal products, tanks, reservoirs and steam generators"},
...
"Manufacture of tanks, reservoirs and containers of metal": {
    ...
    ISIC: {code: "25.2", description: "Manufacture of weapons and ammunition"},
...
"Manufacture of other fabricated metal products": {
    ...
    ISIC: {code: "25.9", description: "Manufacture of other fabricated metal products; metalworking service activities"},
...
"Manufacture of electronic components and boards": {
    ...
    ISIC: {code: "26.1", description: "Manufacture of electronic components and boards"},
...
"Manufacture of computers and peripheral equipment": {
    ...
    ISIC: {code: "26.2", description: "Manufacture of computers and peripheral equipment"},
...
"Manufacture of communication equipment": {
    ...
    ISIC: {code: "26.3", description: "Manufacture of communication equipment"},
...
"Manufacture of consumer electronics": {
    ...
    ISIC: {code: "26.4", description: "Manufacture of consumer electronics"},
...
"Manufacture of measuring testing instruments, clocks and watches": {
    ...
    ISIC: {code: "26.5", description: "Manufacture of measuring, testing, navigating and control equipment; watches and clocks"},
...
"Manufacture of irradiation, electromedical and electrotherapeutic equipment": {
    ...
    ISIC: {code: "26.6", description: "Manufacture of irradiation, electromedical and electrotherapeutic equipment"},
...
"Manufacture of optical instruments, magnetic and optical media and photographic equipment": {
    ...
    ISIC: {code: "26.7", description: "Manufacture of optical instruments and photographic equipment"},
...
"Manufacture of electric motors, generators, transformers and electricity distribution and control apparatus": {
    ...
    ISIC: {code: "27.1", description: "Manufacture of electric motors, generators, transformers and electricity distribution and control apparatus"},
...
"Manufacture of batteries and accumulators": {
    ...
    ISIC: {code: "27.2", description: "Manufacture of batteries and accumulators"},
...
"Manufacture of wiring and wiring devices": {
    ...
    ISIC: {code: "27.3", description: "Manufacture of wiring and wiring devices"},
...
"Manufacture of lighting equipment": {
    ...
    ISIC: {code: "27.4", description: "Manufacture of lighting equipment"},
...
"Manufacture of domestic appliances": {
    ...
    ISIC: {code: "27.5", description: "Manufacture of domestic appliances"},
...
"Manufacture of other electrical equipment": {
    ...
    ISIC: {code: "27.9", description: "Manufacture of other electrical equipment"},
...
"Manufacture of general-purpose machinery": {
    ...
    ISIC: {code: "28.1", description: "Manufacture of general-purpose machinery"},
...
"Manufacture of other general-purpose machinery": {
    ...
    ISIC: {code: "28.2", description: "Manufacture of special-purpose machinery"},
...
"Manufacture of motor vehicles": {
    ...
    ISIC: {code: "29.1", description: "Manufacture of motor vehicles"},
...
"Manufacture of bodies and coachwork for motor vehicles; manufacture of trailers and semi-trailers": {
    ...
    ISIC: {code: "29.2", description: "Manufacture of bodies (coachwork) for motor vehicles; manufacture of trailers and semi-trailers"},
...
"Manufacture of motor vehicle parts and accessories": {
    ...
    ISIC: {code: "29.3", description: "Manufacture of parts and accessories for motor vehicles"},
...
"Building of ships and boats": {
    ...
    ISIC: {code: "30.1", description: "Building of ships and boats"},
...
"Manufacture of railway locomotives and rolling stock": {
    ...
    ISIC: {code: "30.2", description: "Manufacture of railway locomotives and rolling stock"},
...
"Manufacture of air and spacecraft and related machinery": {
    ...
    ISIC: {code: "30.3", description: "Manufacture of air and spacecraft and related machinery"},
...
"Manufacture of military fighting vehicles": {
    ...
    ISIC: {code: "30.4", description: "Manufacture of military fighting vehicles"},
...
"Manufacture of transport equipment n.e.c.": {
    ...
    ISIC: {code: "30.9", description: "Manufacture of transport equipment n.e.c."},
...
"Manufacture of furniture": {
    ...
    ISIC: {code: "31.0", description: "Manufacture of furniture"},
...
"Manufacture of jewellery, bijouterie and related articles": {
    ...
    ISIC: {code: "32.1", description: "Manufacture of jewellery, bijouterie and related articles"},
...
"Manufacture of musical instruments": {
    ...
    ISIC: {code: "32.2", description: "Manufacture of musical instruments"},
...
"Manufacture of sports goods": {
    ...
    ISIC: {code: "32.3", description: "Manufacture of sports goods"},
...
"Manufacture of games and toys": {
    ...
    ISIC: {code: "32.4", description: "Manufacture of games and toys"},
...
"Manufacture of medical and dental instruments and supplies": {
    ...
    ISIC: {code: "32.5", description: "Manufacture of medical and dental instruments and supplies"},
...
"Manufacturing n.e.c.": {
    ...
    ISIC: {code: "32.9", description: "Other manufacturing n.e.c."},
...
"Repair and maintenance of fabricated metal products, machinery and equipment": {
    ...
    ISIC: {code: "33.1", description: "Repair and maintenance of fabricated metal products, machinery and equipment"},
...
"Installation of industrial machinery and equipment": {
    ...
    ISIC: {code: "33.2", description: "Installation of industrial machinery and equipment"},
...
"Electric power generation, transmission and distribution": {
    ...
    ISIC: {code: "35.1", description: "Electric power generation, transmission and distribution activities"},
...
"Manufacture of gas, and distribution of gaseous fuels through mains": {
    ...
    ISIC: {code: "35.2", description: "Manufacture of gas; distribution of gaseous fuels through mains"},
...
"Steam and air conditioning supply": {
    ...
    ISIC: {code: "35.3", description: "Steam and air conditioning supply"},
...
"Activities of brokers and agents for electric power and natural gas": {
    ...
    ISIC: {code: "35.4", description: "Activities of brokers and agents for electric power and natural gas"},
    NACE: {code: "35.4", description: "Activities of brokers and agents for electric power and natural gas"},
    UK_SIC: {code: "35.4", description: ""},
},
"Water collection, treatment and supply": {
    CPA: {code: "36.0", description: "Natural water; water treatment and supply services"},
    ISIC: {code: "36.0", description: "Water collection, treatment and supply"},
...
"Sewerage": {
    ...
    ISIC: {code: "37.0", description: "Sewerage"},
...
"Waste collection": {
    ...
    ISIC: {code: "38.1", description: "Waste collection activities"},
...
"Waste recovery": {
    ...
    ISIC: {code: "38.2", description: "Waste treatment and disposal"},
...
"Waste disposal without recovery": {
    ...
    ISIC: {code: "38.3", description: "Materials and other waste recovery"},
...
"Remediation activities and other waste management service activities": {
    ...
    ISIC: {code: "39.0", description: "Remediation and other waste management service activities"},
...
"Construction of utility projects": {
    ...
    ISIC: {code: "42.2", description: "Construction of utility projects"},
...
"Construction of other civil engineering projects": {
    ...
    ISIC: {code: "42.9", description: "Construction of other civil engineering projects"},
...
"Demolition and site preparation": {
    ...
    ISIC: {code: "43.1", description: "Demolition and site preparation"},
...
"Electrical, plumbing and other construction installation activities": {
    ...
    ISIC: {code: "43.2", description: "Electrical, plumbing and other construction installation activities"},
...
"Building completion and finishing": {
    ...
    ISIC: {code: "43.3", description: "Building completion and finishing"},
...
"Specialised construction activities in construction of buildings": {
    ...
    ISIC: {code: "43.4", description: "Intermediation service activities for specialized construction services"},
    NACE: {code: "43.4", description: "Specialised construction activities in construction of buildings"},
    UK_SIC: {code: "43.4", description: ""},
},
...
"Wholesale on a fee or contract basis": {
    ...
    ISIC: {code: "46.1", description: "Wholesale on a fee or contract basis"},
...
"Wholesale of agricultural raw materials and live animals": {
    ...
    ISIC: {code: "46.2", description: "Wholesale of agricultural raw materials and live animals"},
...
"Wholesale of food, beverages and tobacco": {
    ...
    ISIC: {code: "46.3", description: "Wholesale of food, beverages and tobacco"},
...
"Wholesale of household goods": {
    ...
    ISIC: {code: "46.4", description: "Wholesale of household goods"},
...
"Wholesale of information and communication equipment": {
    ...
    ISIC: {code: "46.5", description: "Wholesale of machinery, equipment and supplies"},
...
"Wholesale of other machinery, equipment and supplies": {
    ...
    ISIC: {code: "46.6", description: "Wholesale of motor vehicles, motorcycles and related parts and accessories"},
...
"Wholesale of motor vehicles, motorcycles and related parts and accessories": {
    ...
    ISIC: {code: "46.7", description: "Other specialized wholesale"},
...
"Non-specialised retail sale": {
    CPA: {code: "47.1", description: ""},
    ISIC: {code: "47.1", description: "Non-specialized retail sale"},
...
"Retail sale of food, beverages and tobacco": {
    ...
    ISIC: {code: "47.2", description: "Retail sale of food, beverages and tobacco"},
...
"Retail sale of automotive fuel": {
    ...
    ISIC: {code: "47.3", description: "Retail sale of automotive fuel"},
...
"Retail sale of information and communication equipment": {
    ...
    ISIC: {code: "47.4", description: "Retail sale of information and communication equipment"},
...
"Retail sale of other household equipment": {
    ...
    ISIC: {code: "47.5", description: "Retail sale of other household equipment"},
...
"Retail sale of cultural and recreational goods": {
    ...
    ISIC: {code: "47.6", description: "Retail sale of cultural and recreational goods"},
...
"Retail sale of other goods, except motor vehicles and motorcycles": {
    ...
    ISIC: {code: "47.7", description: "Retail sale of other goods, except motor vehicles and motorcycles"},
...
"Retail sale of motor vehicles, motorcycles and related parts and accessories": {
    ...
    ISIC: {code: "47.8", description: "Retail sale of motor vehicles, motorcycles and related parts and accessories"},
...
"Intermediation service activities for retail sale": {
    ...
    ISIC: {code: "47.9", description: "Intermediation service activities for retail sale"},
...
"Passenger rail transport": {
    ...
    ISIC: {code: "49.1", description: "Transport via railways"},
...
"Freight rail transport": {
    ...
    ISIC: {code: "49.2", description: "Other land transport"},
...
"Other passenger land transport": {
    ...
    ISIC: {code: "49.3", description: "Transport via pipeline"},
...
"Sea and coastal passenger water transport": {
    ...
    ISIC: {code: "50.1", description: "Sea and coastal water transport"},
...
"Sea and coastal freight water transport": {
    ...
    ISIC: {code: "50.2", description: "Inland water transport"},
...
"Passenger air transport": {
    ...
    ISIC: {code: "51.1", description: "Passenger air transport"},
...
"Freight air transport and space transport": {
    ...
    ISIC: {code: "51.2", description: "Freight air transport"},
...
"Warehousing and storage": {
    ...
    ISIC: {code: "52.1", description: "Warehousing and storage"},
...
"Support activities for transportation": {
    ...
    ISIC: {code: "52.2", description: "Support activities for transportation"},
...
"Other postal and courier activities": {
    ...
    ISIC: {code: "53.2", description: "Courier activities"},
...
"Intermediation service activities for postal and courier activities": {
    ...
    ISIC: {code: "53.3", description: "Intermediation service activities for postal and courier activities"},
    NACE: {code: "53.3", description: "Intermediation service activities for postal and courier activities"},
    UK_SIC: {code: "53.3", description: ""},
},
"Hotels and similar accommodation": {
    CPA: {code: "55.1", description: "Hotel and similar accommodation services"},
    ISIC: {code: "55.1", description: "Hotels and similar accommodation activities"},
...
"Holiday and other short-stay accommodation": {
    ...
    ISIC: {code: "55.2", description: "Other short term accommodation activities"},
...
"Camping grounds and recreational vehicle parks": {
    ...
    ISIC: {code: "55.3", description: "Camping grounds, recreational vehicle parks and trailer parks"},
...
"Intermediation service activities for accommodation": {
    ...
    ISIC: {code: "55.4", description: "Intermediation service activities for accommodation"},
    NACE: {code: "55.4", description: "Intermediation service activities for accommodation"},
    UK_SIC: {code: "55.4", description: ""},
},
"Other accommodation": {
    CPA: {code: "55.9", description: "Other accommodation services"},
    ISIC: {code: "55.9", description: "Other accommodation n.e.c."},
...
"Restaurants and mobile food service activities": {
    ...
    ISIC: {code: "56.1", description: "Restaurants and mobile food service activities"},
...
"Event catering, contract catering service activities and other food service activities": {
    ...
    ISIC: {code: "56.2", description: "Event catering and other food service activities"},
...
"Beverage serving activities": {
    ...
    ISIC: {code: "56.3", description: "Beverage serving activities"},
...
"Intermediation service activities for food and beverage services activities": {
    ...
    ISIC: {code: "56.4", description: "Intermediation service activities for food and beverage services activities"},
    NACE: {code: "56.4", description: "Intermediation service activities for food and beverage services activities"},
    UK_SIC: {code: "56.4", description: ""},
},
"Publishing of books, newspapers and other publishing activities, except software publishing": {
    ...
    ISIC: {code: "58.1", description: "Publishing of books, newspapers, periodicals and other publishing activities"},
...
"Software publishing": {
    ...
    ISIC: {code: "58.2", description: "Software publishing"},
...
"Motion picture, video and television programme activities": {
    ...
    ISIC: {code: "59.1", description: "Motion picture, video and television programme activities"},
...
"Sound recording and music publishing activities": {
    ...
    ISIC: {code: "59.2", description: "Sound recording and music publishing activities"},
...
"Radio broadcasting and audio distribution activities": {
    ...
    ISIC: {code: "60.1", description: "Radio broadcasting and audio distribution activities"},
...
"Television programming, broadcasting and video distribution activities": {
    ...
    ISIC: {code: "60.2", description: "Television programming, broadcasting and video distribution activities"},
...
"News agency and other content distribution activities": {
    ...
    ISIC: {code: "60.3", description: "News agency and other content distribution activities"},
    NACE: {code: "60.3", description: "News agency and other content distribution activities"},
    UK_SIC: {code: "60.3", description: ""},
},
"Wired, wireless, and satellite telecommunication activities": {
    ...
    ISIC: {code: "61.1", description: "Wired, wireless, and satellite telecommunication activities"},
...
"Telecommunication reselling activities and intermediation service activities for telecommunication": {
    ...
    ISIC: {code: "61.2", description: "Telecommunication reselling activities and intermediation service activities for telecommunication"},
...
"Other telecommunication activities": {
    ...
    ISIC: {code: "61.9", description: "Other telecommunication activities"},
...
"Computing infrastructure, data processing, hosting and related activities": {
    ...
    ISIC: {code: "63.1", description: "Computing infrastructure, data processing, hosting and related activities"},
...
"Web search portal activities and other information service activities": {
    ...
    ISIC: {code: "63.9", description: "Web search portals activities and other information service activities"},
...
"Monetary intermediation": {
    ...
    ISIC: {code: "64.1", description: "Monetary intermediation"},
...
"Activities of holding companies and financing conduits": {
    ...
    ISIC: {code: "64.2", description: "Activities of holding companies and financing conduits"},
...
"Activities of trusts, funds and similar financial entities": {
    ...
    ISIC: {code: "64.3", description: "Activities of trusts, funds and similar financial entities"},
...
"Other financial service activities, except insurance and pension funding": {
    ...
    ISIC: {code: "64.9", description: "Other financial service activities, except insurance and pension funding activities"},
...
"Pension funding": {
    ...
    ISIC: {code: "65.3", description: "Pension funding"},
...
"Activities auxiliary to financial services, except insurance and pension funding": {
    ...
    ISIC: {code: "66.1", description: "Activities auxiliary to financial services, except insurance and pension funding"},
...
"Activities auxiliary to insurance and pension funding": {
    ...
    ISIC: {code: "66.2", description: "Activities auxiliary to insurance and pension funding"},
...
"Fund management activities": {
    ...
    ISIC: {code: "66.3", description: "Fund management activities"},
...
"Real estate activities with own property and development of building projects": {
    ...
    ISIC: {code: "68.1", description: "Real estate activities with own or leased property"},
...
"Rental and operating of own or leased real estate": {
    ...
    ISIC: {code: "68.2", description: "Real estate activities on a fee or contract basis"},
...
"Legal activities": {
    ...
    ISIC: {code: "69.1", description: "Legal activities"},
...
"Accounting, bookkeeping and auditing activities; tax consultancy": {
    ...
    ISIC: {code: "69.2", description: "Accounting, bookkeeping and auditing activities; tax consultancy"},
...
"Activities of head offices": {
    ...
    ISIC: {code: "70.1", description: "Activities of head offices"},
...
"Business and other management consultancy activities": {
    ...
    ISIC: {code: "70.2", description: "Business and other management consultancy activities"},
...
"Architectural and engineering activities and related technical consultancy": {
    ...
    ISIC: {code: "71.1", description: "Architectural and engineering, and related technical consultancy activities"},
...
"Technical testing and analysis": {
    ...
    ISIC: {code: "71.2", description: "Technical testing and analysis"},
...
"Research and experimental development on natural sciences and engineering": {
    ...
    ISIC: {code: "72.1", description: "Research and experimental development on natural sciences and engineering"},
...
"Research and experimental development on social sciences and humanities": {
    ...
    ISIC: {code: "72.2", description: "Research and experimental development on social sciences and humanities"},
...
"Advertising": {
    ...
    ISIC: {code: "73.1", description: "Advertising activities"},
...
"Market research and public opinion polling": {
    ...
    ISIC: {code: "73.2", description: "Market research and public opinion polling activities"},
...
"Public relations and communication activities": {
    ...
    ISIC: {code: "73.3", description: "Public relations activities"},
    NACE: {code: "73.3", description: "Public relations and communication activities"},
    UK_SIC: {code: "73.3", description: ""},
},
"Specialised design activities": {
    CPA: {code: "74.1", description: "Specialised design services"},
    ISIC: {code: "74.1", description: "Specialized design activities"},
...
"Photographic activities": {
    ...
    ISIC: {code: "74.2", description: "Photographic activities"},
...
"Translation and interpretation activities": {
    ...
    ISIC: {code: "74.3", description: "Translation and interpretation activities"},
...
"Other professional, scientific and technical activities n.e.c.": {
    ...
    ISIC: {code: "74.9", description: "Other professional, scientific and technical activities n.e.c."},
...
"Veterinary activities": {
    ...
    ISIC: {code: "75.0", description: "Veterinary activities"},
...
"Rental and leasing of motor vehicles": {
    ...
    ISIC: {code: "77.1", description: "Rental and leasing of motor vehicles"},
...
"Rental and leasing of personal and household goods": {
    ...
    ISIC: {code: "77.2", description: "Rental and leasing of personal and household goods"},
...
"Rental and leasing of other machinery, equipment and tangible goods": {
    ...
    ISIC: {code: "77.3", description: "Rental and leasing of other machinery, equipment and tangible goods"},
...
"Leasing of intellectual property and similar products, except copyrighted works": {
    ...
    ISIC: {code: "77.4", description: "Leasing of intellectual property and similar products, except copyrighted works"},
...
"Intermediation service activities for rental and leasing of tangible goods and non-financial intangible assets": {
    ...
    ISIC: {code: "77.5", description: "Intermediation service activities for rental and leasing of tangible goods and non-financial intangible assets"},
    ...
    UK_SIC: {code: "77.5", description: ""},
},
"Activities of employment placement agencies": {
    CPA: {code: "78.1", description: "Services provided by employment placement agencies"},
    ISIC: {code: "78.1", description: "Activities of employment placement agencies"},
...
"Temporary employment agency activities and other human resource provisions": {
    ...
    ISIC: {code: "78.2", description: "Temporary employment agency activities and other human resource provisions"},
...
"Travel agency and tour operator activities": {
    ...
    ISIC: {code: "79.1", description: "Travel agency and tour operator activities"},
...
"Other reservation service and related activities": {
    ...
    ISIC: {code: "79.9", description: "Other travel related activities"},
...
"Cleaning activities": {
    ...
    ISIC: {code: "81.2", description: "Cleaning activities"},
...
"Landscape service activities": {
    ...
    ISIC: {code: "81.3", description: "Landscape service activities"},
...
"Office administrative and support activities": {
    ...
    ISIC: {code: "82.1", description: "Office administrative and support activities"},
...
"Activities of call centres": {
    ...
    ISIC: {code: "82.2", description: "Activities of call centres"},
...
"Organisation of conventions and trade shows": {
    ...
    ISIC: {code: "82.3", description: "Organization of conventions and trade shows"},
...
"Intermediation service activities for business support service activities n.e.c.": {
    ...
    ISIC: {code: "82.4", description: "Intermediation service activities for business support service activities n.e.c., except financial intermediation"},
    NACE: {code: "82.4", description: "Intermediation service activities for business support service activities n.e.c."},
    UK_SIC: {code: "82.4", description: ""},
},
"Business support service activities n.e.c.": {
    CPA: {code: "82.9", description: "Business support services n.e.c."},
    ISIC: {code: "82.9", description: "Business support service activities n.e.c."},
...
"Administration of the State and the economic, social and environmental policies of the community": {
    ...
    ISIC: {code: "84.1", description: "Administration of the State and the economic, social and environmental policies of the community"},
...
"Provision of services to the community as a whole": {
    ...
    ISIC: {code: "84.2", description: "Provision of services to the community as a whole"},
...
"Compulsory social security activities": {
    ...
    ISIC: {code: "84.3", description: "Compulsory social security activities"},
...
"Pre-primary education": {
    ...
    ISIC: {code: "85.1", description: "Pre-primary education"},
...
"Primary education": {
    ...
    ISIC: {code: "85.2", description: "Primary education"},
...
"Secondary and post-secondary non-tertiary education": {
    ...
    ISIC: {code: "85.3", description: "Secondary and post-secondary non-tertiary education"},
...
"Tertiary education": {
    ...
    ISIC: {code: "85.4", description: "Tertiary education"},
...
"Other education": {
    ...
    ISIC: {code: "85.5", description: "Other education"},
...
"Educational support activities": {
    ...
    ISIC: {code: "85.6", description: "Educational support activities"},
...
"Hospital activities": {
    ...
    ISIC: {code: "86.1", description: "Hospital activities"},
...
"Medical and dental practice activities": {
    ...
    ISIC: {code: "86.2", description: "Medical and dental practice activities"},
...
"Other human health activities": {
    ...
    ISIC: {code: "86.9", description: "Other human health activities"},
...
"Residential nursing care activities": {
    ...
    ISIC: {code: "87.1", description: "Residential nursing care activities"},
...
"Residential care activities for persons living with or having a diagnosis of a mental illness or substance abuse": {
    ...
    ISIC: {code: "87.2", description: "Residential care activities for persons living with or having a diagnosis of a mental illness or substance abuse"},
...
"Residential care activities for older persons or persons with physical disabilities": {
    ...
    ISIC: {code: "87.3", description: "Residential care activities for older persons or persons with physical disabilities"},
...
"Other residential care activities": {
    ...
    ISIC: {code: "87.9", description: "Other residential care activities"},
...
"Social work activities without accommodation for older persons or persons with disabilities": {
    ...
    ISIC: {code: "88.1", description: "Social work activities without accommodation for older persons or persons with disabilities"},
...
"Other social work activities without accommodation": {
    ...
    ISIC: {code: "88.9", description: "Other social work activities without accommodation"},
...
"Museum, collection, historical site and monument activities": {
    ...
    ISIC: {code: "91.2", description: "Museum, collection, historical site and monument activities"},
    NACE: {code: "91.2", description: "Museum, collection, historical site and monument activities"},
    UK_SIC: {code: "91.2", description: ""},
},
"Conservation, restoration and other support activities for cultural heritage": {
    ...
    ISIC: {code: "91.3", description: "Conservation, restoration and other support activities for cultural heritage"},
    NACE: {code: "91.3", description: "Conservation, restoration and other support activities for cultural heritage"},
    UK_SIC: {code: "91.3", description: ""},
},
"Botanical and zoological garden and nature reserve activities": {
    ...
    ISIC: {code: "91.4", description: "Botanical and zoological garden and nature reserve activities"},
    NACE: {code: "91.4", description: "Botanical and zoological garden and nature reserve activities"},
    UK_SIC: {code: "91.4", description: ""},
},
"Gambling and betting activities": {
    CPA: {code: "92.0", description: "Gambling and betting services"},
    ISIC: {code: "92.0", description: "Gambling and betting activities"},
...
"Sports activities": {
    ...
    ISIC: {code: "93.1", description: "Sports activities"},
...
"Amusement and recreation activities": {
    ...
    ISIC: {code: "93.2", description: "Amusement and recreation activities"},
...
"Activities of business, employers and professional membership organisations": {
    ...
    ISIC: {code: "94.1", description: "Activities of business, employers and professional membership organizations"},
...
"Activities of trade unions": {
    ...
    ISIC: {code: "94.2", description: "Activities of trade unions"},
...
"Activities of other membership organisations": {
    ...
    ISIC: {code: "94.9", description: "Activities of other membership organizations"},
...
"Repair and maintenance of computers and communication equipment": {
    ...
    ISIC: {code: "95.1", description: "Repair and maintenance of computers and communication equipment"},
...
"Repair and maintenance of personal and household goods": {
    ...
    ISIC: {code: "95.2", description: "Repair and maintenance of personal and household goods"},
...
"Repair and maintenance of motor vehicles and motorcycles": {
    ...
    ISIC: {code: "95.3", description: "Repair and maintenance of motor vehicles and motorcycles"},
    NACE: {code: "95.3", description: "Repair and maintenance of motor vehicles and motorcycles"},
    UK_SIC: {code: "95.3", description: ""},
},
"Intermediation service activities for repair and maintenance of computers, personal and household goods, and motor vehicles and motorcycles": {
    ...
    ISIC: {code: "95.4", description: "Intermediation service activities for repair and maintenance of computers, personal and household goods, and motor vehicles and motorcycles"},
...
"Washing and cleaning of textile and fur products": {
    ...
    ISIC: {code: "96.1", description: "Washing and cleaning of textile and fur products"},
    NACE: {code: "96.1", description: "Washing and cleaning of textile and fur products"},
    UK_SIC: {code: "96.1", description: ""},
},
...
"Undifferentiated goods-producing activities of private households for own use": {
    ...
    ISIC: {code: "98.1", description: "Undifferentiated goods-producing activities of private households for own use"},
...
"Undifferentiated service-producing activities of private households for own use": {
    ...
    ISIC: {code: "98.2", description: "Undifferentiated service-producing activities of private households for own use"},
...
"Activities of extraterritorial organisations and bodies": {
    ...
    ISIC: {code: "99.0", description: "Activities of extraterritorial organizations and bodies"},
